...
import com.nicolaischirmer.proyectoapirickymorty.firebase.AuthRes
import com.nicolaischirmer.proyectoapirickymorty.ui.theme.Purple40
...
suspend fun signUp(navigateToHome: () -> Unit, auth: AuthManager, email: String, password: String, context: Context) {
    if (email.isNotEmpty() && password.isNotEmpty()) {
        when (
            ...
            is AuthRes.Error -> TODO()
            is AuthRes.Success -> TODO()
        }
    }
    else {
